...
use RSL\EventManager\Event;

use RSL\Stdlib\RequestInterface
    as Request;

use RSL\Stdlib\ResponseInterface
    as Response;

use RSL\View\Model\ModelInterface
    as Model;

use RSL\View\Model\ViewModel;
...
// =====================================
// ERRORS WORK (РАБОТА С ОШИБКАМИ)
// =====================================
    /**
     * Does the event represent an error response?
     * Означает ли событие сообщение об ошибке?
     *
     * @return bool
     */
     ...
     * (указав ошибку в запросе на обработку)
     *
     ...
     * Получить сообщение об ошибке, если оно есть
     *
     * @return string
     */
...
// =====================================
     ...
     * Получить имя зарегистрированного контроллера
     *
     * @return string
     */
